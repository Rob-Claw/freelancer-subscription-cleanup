...
**Agent creation rule:** when Gabriel asks to create, wire, or verify a specialist/sub-agent, first check and follow `/home/openclaw/.openclaw/workspace/skills/create-agent/SKILL.md` before doing anything else.
